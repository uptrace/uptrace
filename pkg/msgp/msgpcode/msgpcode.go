...
func IsString(c byte) bool      { return IsFixedString(c) || c == Str8 || c == Str16 || c == Str32 }
func IsBin(c byte) bool         { return c == Bin8 || c == Bin16 || c == Bin32 }
...
func IsFixedExt(c byte) bool    { return c >= FixExt1 && c <= FixExt16 }
func IsExt(c byte) bool         { return IsFixedExt(c) || c == Ext8 || c == Ext16 || c == Ext32 }
