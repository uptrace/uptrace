...
func (q *DropTableQuery) Model(model any) *DropTableQuery { q.setTableModel(model); return q }
...
func (q *DropTableQuery) IfExists() *DropTableQuery { q.ifExists = true; return q }
