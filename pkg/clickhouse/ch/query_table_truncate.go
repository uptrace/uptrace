...
func (q *TruncateTableQuery) Model(model any) *TruncateTableQuery { q.setTableModel(model); return q }
...
func (q *TruncateTableQuery) IfExists() *TruncateTableQuery { q.ifExists = true; return q }
