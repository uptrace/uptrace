...
func (r *Reader) Int8() (int8, error)   { num, err := r.UInt8(); return int8(num), err }
func (r *Reader) Int16() (int16, error) { num, err := r.UInt16(); return int16(num), err }
func (r *Reader) Int32() (int32, error) { num, err := r.UInt32(); return int32(num), err }
func (r *Reader) Int64() (int64, error) { num, err := r.UInt64(); return int64(num), err }
