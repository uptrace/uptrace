...
func (q *SelectQuery) Conn(conn IConn) *SelectQuery { q.setConn(conn); return q }
func (q *SelectQuery) Model(model any) *SelectQuery { q.setTableModel(model); return q }
func (q *SelectQuery) Err(err error) *SelectQuery   { q.setErr(err); return q }
...
func (q *SelectQuery) Limit(limit int) *SelectQuery   { q.limit = limit; return q }
func (q *SelectQuery) Offset(offset int) *SelectQuery { q.offset = offset; return q }
func (q *SelectQuery) Final() *SelectQuery            { q.final = true; return q }
