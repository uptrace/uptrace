...
func (c *NullableInt8Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableUInt8Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableInt16Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableUInt16Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableInt32Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableUInt32Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableInt64Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableUInt64Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableFloat32Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableFloat64Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableBoolColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableStringColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableBytesColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableEnumColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableLCStringColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableDateTimeColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableGoDateTimeColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableDateColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableDateTime64Column) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableUUIDColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
func (c *NullableTDigestColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
...
type NullableVariantColumn struct {
	ColumnOf[*Variant]
	Nulls UInt8Column
	Data  VariantColumn
}

var _ Columnar = (*NullableVariantColumn)(nil)

func NewNullableVariantColumn() Columnar { return &NullableVariantColumn{} }
func (c *NullableVariantColumn) Init(chType string, goType reflect.Type) error {
	return c.Data.Init(chArrayElemType(chType), nil)
}
func (c *NullableVariantColumn) Clear() {
	c.ColumnOf.Clear()
	c.Nulls.Clear()
	c.Data.Clear()
}
func (c *NullableVariantColumn) Grow(numRow int) {
	c.ColumnOf.Grow(numRow)
	c.Nulls.Grow(numRow)
	c.Data.Grow(numRow)
}

var nullableVariantType = reflect.TypeFor[*Variant]()

func (c *NullableVariantColumn) Type() reflect.Type { return nullableVariantType }
func (c *NullableVariantColumn) ConvertAssign(idx int, typ reflect.Type, ptr unsafe.Pointer) error {
	if c.Nulls.Column[idx] == 1 {
		return nil
	}
	dest := reflect.NewAt(typ, ptr).Elem()
...
func (c *NullableVariantColumn) ReadData(rd *chproto.Reader, numRow int) error {
	if err := c.Nulls.ReadData(rd, numRow); err != nil {
		return err
	}
	if err := c.Data.ReadData(rd, numRow); err != nil {
...
func (c *NullableVariantColumn) WriteData(wr *chproto.Writer) error {
	for _, el := range c.Column {
		if el != nil {
			c.Nulls.Column = append(c.Nulls.Column, 0)
			c.Data.Column = append(c.Data.Column, *el)
...
type ArrayVariantColumn struct {
	ColumnOf[[]Variant]
	elem VariantColumn
}

var _ Columnar = (*ArrayVariantColumn)(nil)

func NewArrayVariantColumn() Columnar { return new(ArrayVariantColumn) }
func (c *ArrayVariantColumn) Init(chType string, goType reflect.Type) error {
	return c.elem.Init(chArrayElemType(chType), nil)
}

var arrayVariantType = reflect.TypeFor[[]Variant]()

func (c *ArrayVariantColumn) Type() reflect.Type                  { return arrayVariantType }
func (c *ArrayVariantColumn) ReadPrefix(rd *chproto.Reader) error { return c.elem.ReadPrefix(rd) }
func (c *ArrayVariantColumn) ReadData(rd *chproto.Reader, numRow int) error {
	offsets, err := readOffsets(rd, numRow)
	if err != nil {
		return err
	}
...
func (c *ArrayVariantColumn) WritePrefix(wr *chproto.Writer) error { return c.elem.WritePrefix(wr) }
func (c *ArrayVariantColumn) WriteData(wr *chproto.Writer) error {
	_ = c.writeOffset(wr, 0)
	if _, ok := (any)(c.elem).(CustomEncoding); ok {
		c.elem.Grow(len(c.Column))
		for _, el := range c.Column {
...
func (c *ArrayVariantColumn) writeOffset(wr *chproto.Writer, offset int) int {
	for _, el := range c.Column {
		offset += len(el)
		wr.UInt64(uint64(offset))
	}
...
type ArrayNullableVariantColumn struct {
	ColumnOf[[]*Variant]
	elem NullableVariantColumn
}

var _ Columnar = (*ArrayNullableVariantColumn)(nil)

func NewArrayNullableVariantColumn() Columnar { return new(ArrayNullableVariantColumn) }
func (c *ArrayNullableVariantColumn) Init(chType string, goType reflect.Type) error {
	return c.elem.Init(chArrayElemType(chType), goType)
}

var arrayNullableVariantType = reflect.TypeFor[[]*Variant]()

func (c *ArrayNullableVariantColumn) Type() reflect.Type { return arrayNullableVariantType }
func (c *ArrayNullableVariantColumn) ReadPrefix(rd *chproto.Reader) error {
	return c.elem.ReadPrefix(rd)
}
func (c *ArrayNullableVariantColumn) ReadData(rd *chproto.Reader, numRow int) error {
	offsets, err := readOffsets(rd, numRow)
	if err != nil {
		return err
	}
...
func (c *ArrayNullableVariantColumn) WritePrefix(wr *chproto.Writer) error {
	return c.elem.WritePrefix(wr)
}
func (c *ArrayNullableVariantColumn) WriteData(wr *chproto.Writer) error {
	var offset int
	for _, el := range c.Column {
		offset += len(el)
		wr.UInt64(uint64(offset))
...
type ArrayArrayVariantColumn struct {
	ColumnOf[[][]Variant]
	elem ArrayVariantColumn
}

var _ Columnar = (*ArrayArrayVariantColumn)(nil)

func NewArrayArrayVariantColumn() Columnar { return new(ArrayArrayVariantColumn) }
func (c *ArrayArrayVariantColumn) Init(chType string, goType reflect.Type) error {
	return c.elem.Init(chArrayElemType(chArrayElemType(chType)), nil)
}

var arrayArrayVariantType = reflect.TypeFor[[][]Variant]()

func (c *ArrayArrayVariantColumn) Type() reflect.Type                  { return arrayArrayVariantType }
func (c *ArrayArrayVariantColumn) ReadPrefix(rd *chproto.Reader) error { return c.elem.ReadPrefix(rd) }
func (c *ArrayArrayVariantColumn) ReadData(rd *chproto.Reader, numRow int) error {
	offsets, err := readOffsets(rd, numRow)
	if err != nil {
		return err
	}
...
func (c *ArrayArrayVariantColumn) WritePrefix(wr *chproto.Writer) error {
	return c.elem.WritePrefix(wr)
}
func (c *ArrayArrayVariantColumn) WriteData(wr *chproto.Writer) error {
	var offset int
	for _, el := range c.Column {
		offset += len(el)
		wr.UInt64(uint64(offset))
