...
// Components
import MetricGroupByList from '@/metrics/query/MetricGroupByList.vue'

export default defineComponent({
  name: 'MetricsGroupByMenu',
  components: { MetricGroupByList },
  ...
  setup(props) {
    ...
    function groupBy(sugg: Item) {
      const editor = props.uql.createEditor()
      editor.add(`group by ${sugg.value}`)
